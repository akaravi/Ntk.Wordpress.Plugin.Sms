...
class WoocommerceIR_SMS_Gateways
{
	...
	public function smsban()
	{
		...
		//wp_die(var_dump([$username , $password , $from , $to ,$massage] , $data_to_send));
	    ...
	    foreach($to as $item){
	        $data_to_send = "username=$username&password=$password&to=$item&text=" . urlencode($massage);
